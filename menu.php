<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true"> 
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="index.php"><i class="mbri-desktop"></i><span class="menu-title" data-i18n="Dashboard">Mi Negocio</span></a></li>
                <li class=" nav-item"><a href="con_inventarios.php"><i class="mbri-sites"></i><span class="menu-title" data-i18n="Templates">Inventario</span></a></li>
